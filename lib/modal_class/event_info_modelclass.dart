...
//
//     final eventDetailsModelclass = eventDetailsModelclassFromJson(jsonString);

import 'dart:convert';

EventDetailsModelclass eventDetailsModelclassFromJson(String str) => EventDetailsModelclass.fromJson(json.decode(str));

String eventDetailsModelclassToJson(EventDetailsModelclass data) => json.encode(data.toJson());

class EventDetailsModelclass {
  EventDetailsModelclass({
    this.status,
    this.message,
    this.event,
  });
  ...
  factory EventDetailsModelclass.fromJson(Map<String, dynamic> json) => EventDetailsModelclass(
    status: json["status"],
    message: json["message"],
    event: AboutEvent.fromJson(json["event"]),
  );
