...
import 'package:dycca_partner/bloc_controllers/event_request_bloc.dart';
...
class _EventRequestScreenState extends State<EventRequestScreen> {
  ...
  Widget build(BuildContext context) {
    return Container(
      height: 200,
      child: StreamBuilder<List<Eventreq>>(
          stream: _bloc.EventListStream,
          builder: (context, snapshot) {

            return ListView.builder(shrinkWrap: true,itemCount: snapshot.data?.length??0,itemBuilder:
             (context,index) {
                return Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      snapshot.data?[index].event?.mcat.typeName.toString()??"",
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Expanded(
                                        flex: 4,
                                        child: Text(
                                          snapshot.data?[index].event?.startDate.toString().split(" ").first??"",
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Expanded(
                                          flex: 4,
                                          child: Text(
                                            snapshot.data?[index].event?.eventName.toString()??"",
                                            style: fontStyle(neutral5Color, FontWeight.w400, 14),
                                          ),
                                        ),
                                      ],
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Expanded(
                                          flex: 4,
                                          child: Text(
                                            snapshot.data?[index].event?.subcat.typeName.toString()??"",
                                            style: fontStyle(neutral5Color, FontWeight.w400, 14),
                                          ),
                                        ),
                                      ],
