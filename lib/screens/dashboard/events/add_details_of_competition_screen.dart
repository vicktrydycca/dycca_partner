...
class AddDetailsOfCompetitionScreen extends StatefulWidget {
  ...
  final eventDesc;
  final eventID;
  const AddDetailsOfCompetitionScreen(
      {Key? key,
      this.eventID,
      this.competitionType,
      this.competitionSubType,
      this.eventName,
      this.eventDesc})
      : super(key: key);

  @override
  State<AddDetailsOfCompetitionScreen> createState() =>
      _AddDetailsOfCompetitionScreenState();
}

class _AddDetailsOfCompetitionScreenState
    extends State<AddDetailsOfCompetitionScreen> {
  ...
  Widget tabbars() {
    return TabBarView(
      children: [
                              ...
                              child: GestureDetector(
                                onTap: () {
                                  Navigator.pushNamed(
                                      ...
                                      arguments: {
                                        "appbar": items[index],
                                        "categoryType": widget.competitionType,
                                        "categorySubType":
                                            widget.competitionSubType,
        ...
        HostEventScreen(
            categoryTypeID: widget.competitionType,
            subCategoryTypeID: widget.competitionSubType,
            eventName: widget.eventName,
            eventDesc: widget.eventDesc,
            eventID: widget.eventID),
      ],
